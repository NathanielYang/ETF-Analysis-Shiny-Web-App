...
#View(cbind(`^GSPC`, BJK))
#a <- merge(a, XLY, by.x = "Date", by.y = "Date")

BJK$logreturn <- BJK$logreturn_BJK
`^GSPC`$logreturn <- BJK$logreturn_SP
FUD$logreturn <- BJK$logreturn_FUD
IGN$logreturn <- BJK$logreturn_IGN
PAGG$logreturn <- BJK$logreturn_PAGG
PBJ$logreturn <- BJK$logreturn_PBJ
PBS$logreturn <- BJK$logreturn_PBS
PEJ$logreturn <- BJK$logreturn_PEJ
XLP$logreturn <- BJK$logreturn_XLP
XLY$logreturn <- BJK$logreturn_XLY